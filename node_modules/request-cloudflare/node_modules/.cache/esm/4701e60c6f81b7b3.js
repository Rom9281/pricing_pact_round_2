let vm,requestModule,Debug;_6f8‍.x([["requestCloudflare",()=>requestCloudflare],["default",()=>requestCloudflare]]);_6f8‍.w("vm",[["default",["vm"],function(v){vm=v}]]);_6f8‍.w("request",[["default",["requestModule"],function(v){requestModule=v}]]);_6f8‍.w("debug",[["default",["Debug"],function(v){Debug=v}]]);
...
function solveChallenge(response, body, options, callback) {
  setTimeout(()=>{
    ...
    try {
      options.qs.jschl_answer = (_6f8‍.u(eval(_6f8‍.c(challenge))) + response.request.host.length);
    } catch (err) {
